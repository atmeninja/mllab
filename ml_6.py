...
Original file is located at
    https://colab.research.google.com/drive/1DH5vAOzoHhsLmVCJhTJmKNLbcNX4IHZa
"""
...
# Fit and plot simple linear regression
...
# Plot locally weighted regression curves for different tau values
